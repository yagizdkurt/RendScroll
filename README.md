...
![RendScroll — a rendered scene, parchment and gold](src/STDImages/showpic.png)
...
> Dar, nemli koridorda kirli bir köylü kendi kendine mırıldanır. Sizi görünce
> üstünüze atılır.
`Amaç kaynak tüketmek değil — lanetin gerçek olduğunu göster.`
...
their order and label in the sidebar. A number-only name like `1.md` uses the
file's first `# Title` as its sidebar label.
